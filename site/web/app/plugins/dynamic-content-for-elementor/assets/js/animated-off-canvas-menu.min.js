...
var time_menu_pane_opening=Number(elementSettings.time_menu_pane_opening.size)/1000;var time_menu_list_opening=Number(elementSettings.time_menu_list_opening.size)/1000;var deviceMode=$('body').attr('data-elementor-device-mode');if(deviceMode=='tablet'&&rate_menuside_tablet){rate_menuside=rate_menuside_tablet}else if(deviceMode=='mobile'&&rate_menuside_mobile){rate_menuside=rate_menuside_mobile}
